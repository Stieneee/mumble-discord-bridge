...
| MUMBLE_CHANNEL             | -mumble-channel             | string  | ''               | mumble channel to start in, using '\/' to separate nested channels, optional,  and use ' ' around env so that escape characthers won't cause any issue                                                    |
